...
<head>
    ...
    <title>SCA-SJV | TASAS MUNICIPALES</title>
    ...
    <section id="appointment" class="appointment section-bg" style="padding-top: 10em;">
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-title">
                <h2>Estado de cuenta | Tasas Municipales</h2>
            ...
            <form method="POST" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="form-row" id="divTCobros">
                    <div class="col-md-3 form-group">
                        <label class="titu">Alumbrado</label>
                        <input readonly type="text" name="alum" id="alum" class="form-control" value="<?php if (isset($get_tcobros)) {
                                                                                                            echo $get_tcobros->alumbrado;
                                                                                                        }
                                                                                                        ?>">
                    </div>
                    <div class="col-md-3 form-group">
                    ...
                    <div class="col-md-3 form-group">
                        <label class="titu">Pavimento</label>
                        <input readonly type="text" name="pav" id="pav" class="form-control" value="<?php if (isset($get_tcobros)) {
                                                                                                        echo $get_tcobros->pavimentacion;
                                                                                                    }
                                                                                                    ?>">
                    </div>
                    <div class="col-md-3 form-group">
                        <label class="titu">Tasa mensual</label>
                        <input readonly type="text" name="tot" id="tot" class="form-control" value="<?php if (isset($get_tcobros)) {
                            ...
                            <?php if (isset($detalle_cuenta)) {
                                foreach ($detalle_cuenta as $detalle) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo $detalle->alumbrado_ec ?></td>
                                        <td><?php echo $detalle->aseo_ec ?></td>
                                        <td><?php echo $detalle->pavimento_ec ?></td>
