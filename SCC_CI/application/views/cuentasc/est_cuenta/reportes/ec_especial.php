...
$pdf->SetSubject('Contribución Especial');
...
$fecha = date('d-m-Y');
$cuerpo_pdf = <<<OED
<h1 align="center">Estado de cuenta | Contribución Especial</h1><br/>
...
$table .= '<tr>
                <td colspan="5"></td>
				<td style="border:1px solid #000;" colspan="2"><strong>Meses detallados</strong></td>
				<td style="border:1px solid #000;"><strong>' . $pie->meses_retraso . '</strong></td>
			</tr>
			<tr>
                <td colspan="5"></td>
				<td style="border:1px solid #000;" colspan="2"><strong>Sub-total</strong></td>
				<td style="border:1px solid #000;"><strong>$ ' . $pie->total_calculo . '</strong></td>
			</tr>
			<tr>
                <td colspan="5"></td>
				<td style="border:1px solid #000;" colspan="2"><strong>5% Fiesta</strong></td>
				<td style="border:1px solid #000;" ><strong>$ ' . $pie->fiesta_ec . '</strong></td>
			</tr>';
$table .= '</table>';
