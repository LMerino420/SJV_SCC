...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists(K_PATH_IMAGES.'sjv_logo.jpg')) {
		$tcpdf_header_logo = 'sjv_logo.jpg';
	}
...
if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'Alcaldia Municipal de San Jose Villanueva');
}

if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "Departamento: Cuentas Corrientes");
}
